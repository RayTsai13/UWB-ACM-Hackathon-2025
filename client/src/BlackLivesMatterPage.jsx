...
function BlackLivesMatterPage() {
  const trend = {
    title: "Black Lives Matter",
    description: "The Black Lives Matter movement began in 2013 after the acquittal of Trayvon Martin's killer and gained global prominence in 2020 following the murder of George Floyd. The movement, which fights against systemic racism and police brutality, became one of the largest social movements in U.S. history. Through social media, it has amplified Black voices, organized protests worldwide, and brought attention to racial injustice.",
    year: 2013,
    impact: "Sparked global conversations about racial justice and police reform",
    stats: {
      protests: "7,750+",
      countries: "60+",
      ...
      <main style={{
        ...
        <section style={{ 
          ...
          <p style={{ marginBottom: '1rem' }}>
            The Black Lives Matter movement continues to advocate for racial justice and equality.
          </p>
          <a 
